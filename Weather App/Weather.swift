//Credit to B Advent for this ready to use class/library that we dragged/droped and edited.
...
struct Weather {
    ...
    init(json:[String: Any]) throws {
        ...
        guard let temperature = json["temperatureHigh"] as? Double else {
    ...
    static let basePath = "https://api.darksky.net/forecast/352798f8a1661216ef2c7ce6b2344fa9/"
